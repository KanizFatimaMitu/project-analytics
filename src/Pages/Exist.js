...
import { faChessQueen, faCheckCircle } from '@fortawesome/free-solid-svg-icons'
...
const Exist = () => {
    return (
        <div className='appGlass'>
            ...
            <div class="hero h-[600px] w-[800px] mx-auto my-24">
                <h2 className='mt-[-530px] text-primary-content font-bold text-2xl justify-center '>welcome to  <span className='text-5xl font-bold text-primary-content ml-6'><FontAwesomeIcon icon={faChessQueen} /></span>
                    <span className='text-5xl ml-4 font-bold text-primary-content'>Shapers !!!</span> </h2>
                <div class="hero-content flex-col lg:flex-row-reverse">

                    <div class="text-center lg:text-left">
                        <h1 class="text-4xl text-primary-content font-bold">Login now!</h1>
                    ...
                    <div class="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                        <div class="card-body">
                            ...
                            <div class="form-control mt-6">
                                <button class="btn btn-primary-focus"><NavLink to='/'>Login</NavLink></button>
                            </div>
                        </div>
                    </div>
                </div>
